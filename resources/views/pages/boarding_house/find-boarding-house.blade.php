@extends('layouts.app')
@section('title', 'Find Boarding House')
...
@section('content')
    ...
    <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
        ...
        <form action="{{ route('boarding-house.result') }}"
            ...
            <div id="InputContainer" class="flex flex-col gap-[18px]">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        ...
                        <select name="city" id="city_data" class="appearance-none outline-none w-full bg-white pl-8">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        ...
                        <img src="{{ asset('assets/images/icons/location.svg') }}"
                            class="absolute w-5 h-5 flex shrink-0 transform -translate-y-1/2 top-1/2 left-5" alt="icon">
                        <select name="category" id="category_data"
                            class="appearance-none outline-none w-full bg-white pl-8">
        ...
        <nav class="fixed bottom-5 w-full max-w-[640px] px-5 z-10">
            <div class="grid grid-cols-4 h-fit rounded-[40px] justify-between py-4 px-5 bg-ngekos-black">
                <a href="index.html" class="flex flex-col items-center text-center gap-2">
                    <img src="{{ asset('assets/images/icons/global.svg') }}" class="w-8 h-8 flex shrink-0" alt="icon">
                ...
                <a href="find-kos.html" class="flex flex-col items-center text-center gap-2">
                    <img src="{{ asset('assets/images/icons/search-status-green.svg') }}" class="w-8 h-8 flex shrink-0"
                        alt="icon">
