@extends('layouts.app')
@section('title', 'Categories Result')
...
@section('content')
    ...
    <div id="Header" class="relative flex items-center justify-between gap-2 px-5 mt-[18px]">
        <div class="flex flex-col gap-[6px]">
            <h1 class="font-bold text-[32px] leading-[48px]">Kos in {{ ucfirst($category->name) }}</h1>
            <p class="text-ngekos-grey">Tersedia {{ $items->count() }}</p>
        </div>
